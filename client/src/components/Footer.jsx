...
const Footer = () => {
  return (
    <div className='bg-gray-900 text-gray-500 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
    ...
    <h2 className="text-3xl font-extrabold text-white ">
        Stay<span className="text-primary">Tonight</span>
    </h2>
</div>
                    <p className='text-sm'>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} <a href="https://prebuiltui.com">❤️By Vaibhav</a>. All rights reserved.</p>
