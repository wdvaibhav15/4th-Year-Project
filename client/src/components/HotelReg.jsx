        ...
        <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
          ...
          {/* Select City Drop Down */}
            <div className="w-full mt-4 max-w-60 mr-auto">
                <label htmlFor="city" className="font-medium text-gray-500l">City</label>
            ...
            <button className="bg-indigo-500 hover:bg-indigo-600 transition-all text-white mr-auto px-6 py-2 rounded-md cursor-pointer mt-6">Register</button>
        </div>
      </form>
    </div>
  )
